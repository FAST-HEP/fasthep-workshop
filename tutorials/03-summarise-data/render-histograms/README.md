...
```bash
pixi run fasthep run tutorials/03-summarise-data/render-histograms/author.yaml --outdir build/tutorials/03-summarise-data/render-histograms
```
...
- `build/tutorials/03-summarise-data/render-histograms/artifacts/histograms/`
- `build/tutorials/03-summarise-data/render-histograms/artifacts/plots/`
- `build/tutorials/03-summarise-data/render-histograms/render/`
- `build/tutorials/03-summarise-data/render-histograms/run_summary.yaml`
